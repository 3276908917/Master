...
Daniel Farrow \text{orange}{(and who else?) add these people to the 
Danksagung}. We begin by invoking the \verb|lhs| function of
...
select the hypercube sample with the largest minimum separation.
...
of some given dimension and total number of samples. Let us consider a 
