...
\begin{figure}[htb]
  ...
  Table~\ref{tab: Aleitheia_m0} defines this model in terms
...
POWER SPECTRUM GOES HERE.
what should go in the caption? just the model definition? Yeah, then we can
talk about BAO and turnover scale later.

A standard Planck $\Lambda$CDM model is shown in
figure~\ref{fig: first_power_spectrum}. TALK ABOUT THE ALETHEIA MODEL.
...
its \textit{unique} dependence on each of these parameters.
