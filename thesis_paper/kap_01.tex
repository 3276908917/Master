...
linear-theory power spectra of non-neutrino matter. \textcolor{red}{What
was Andrea's complaint here?} Emulators of non-linear power spectra are 
...
radiation, then by matter. The power spectrum displays this history, as the
smaller Fourier modes, So, depending on when a Fourier mode enters the
``horizon'' (the ), this power spectrum can be fit
...
convention also persists in emulator literature (\textcolor{green}{citation}).
