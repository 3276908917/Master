...
in the equations that govern the evolution of the Universe. One way of
writing the first Friedmann equation is:
...
the Universe (which is, by convention set to unity at the present day), and $K$ characterizes the Universe's curvature as
