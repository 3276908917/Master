...
Unfortunately, the use of $h^{-1}$ Mpc units represents not just a harmless
convention. Our incomplete understanding of $h$
...
for $\sigma_8$, these units became customary in the times when GRS redshift 
ranges \textcolor{orange}{IN PROGRESS}.
