...
Contrast this with random sampling, figure~\ref{fig: sample_comparison}.

\begin{equation}
\label{eq: best_lhs_sep}
s = \left( \frac{1}{N_s} \right)^{1 / d}
\end{equation}

For example, for a six-parameter emulator trained over 5000 samples, the best
possible LHS would have a minimum separation of $s \approx 0.2418$.
