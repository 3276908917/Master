...
\begin{equation}
w_\text{DE} = \eulw_0 + \eulw_a (1 - a)
\end{equation}

These $\eulw_0$ and $\eulw_a$ are cosmological parameters which also appear in our
statistical analyses, although our observations so far appear to support
a cosmological constant solution: $\eulw_0 = -1$ and $\eulw_a$ = 0. In the first
