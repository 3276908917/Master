...
interpolation instead of the equations of evolution. Power spectra emulation 
has been shown to achieve excellent accuracy with computation times shorter
by several orders of magnitude. Emulators apply different machine
...
several emulators of both linear and nonlinear power spectra have been put 
...
\verb|baccoemu|
includes both nonlinear and linear power spectrum emulators based on neural
networks with quoted accuracies of 0.2\% for \cbib{Arico}.
\verb|CosmoPower| also uses an NN. 
\verb|COMET| uses GPR, although the development team
...
NNs represent the most
common approach in the literature. GPR is a considerably simpler approach and are arguably more accessible to novices.
