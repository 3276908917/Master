...
in addition to the shape parameters, we need only train the emulator over a 
single evolution parameter, $\sigma_{12}$.
...
if we explicitly trained over additional evolution parameters, the evolution
mapping degeneracy would result in wasted samples.
