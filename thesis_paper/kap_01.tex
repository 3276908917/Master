...
modern Monte Carlo Markov Chain analysis, tens of thousands of cosmological
configurations will need to be evaluated. Therefore, evaluation of power
spectra becomes a bottleneck of the analysis.

This motivates the use of emulation, which is \textcolor{red}{a kind of} 
multi-dimensional interpolation. Power spectra emulation has been shown
to achieve excellent accuracy (\textcolor{green}{on the order of}) while
returning results several orders of magnitude more quickly.
...
I'll talk a little about different emulators currently available, such as 
...
Emulators of non-linear  power spectra $P_\text{NL}(k)$ are 
