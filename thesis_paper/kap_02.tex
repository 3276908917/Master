...
replacement of $\sigma_{12}$ with $\tilde{\sigma_{12}}$ and the inclusion 
...
\section{Characterizing the Amplitude of the Power Spectrum}
...
with the same shape parameters but different evolution parameters. The
cosmologies are evaluated at different redshifts such that they have the same
value of $\tilde{\sigma}_{12}$
...
\textcolor{blue}{Rewrite the first part of this section!}

We combine the power spectrum of its MEMNeC with an approximation of the ratio
between the two:
