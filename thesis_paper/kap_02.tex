...
\textcolor{blue}{You might think that this is sort of an inappropriate section
...
For example, one parameter that tripped me up for a while: neutrino mass 
...
hierarchies involve two eigenstates?
...
To test this setup, we compare our results with those of Ariel S\'{a}nchez (within the native Fortran framework of CAMB) and
