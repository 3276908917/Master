...
\texttt|npy| files and later rescaled according to specify the training
...
CL is packaged with three pairs of prior files. The parameter domains for each
pair are
