...
% This formatting sucks but I don't want to output extra spaces.
\newcommand{\cbib}[1]
{\IfFileExists{biblatex.sty}
{\cite{#1}}
...
\textit{What is an emulator? How do we train it?} (\cbib{Arico}, \cbib{Mancini}).
...
by \cbib{San20} and \cbib{San21}, and which we will summarize in the next
section.\footnote{Clunky to look ahead like this, can we reorganize?}
...
ambiguities (\cbib{San20}) which are outside of the scope of this work.
