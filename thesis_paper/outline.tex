...
What is a Gaussian Process? Why are we using it instead of a neural network?

The two reasons I can remember off of the top of my head: 1. NNs generally need much larger sample sizes to reach comparable levels of accuracy. 2. NNs invariably require much more complicated setup and tuning. By contrast, as we explain in section~\ref{sec: emu_training}, a Gaussian process regression is highly straightforward to set up and straightforward to modify.
